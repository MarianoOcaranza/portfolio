        ...
        <div id='inicio'>
            <div className="flex flex-col gap-10 min-h-[calc(100vh-100px)] sm:flex-row sm:text-left text-center sm:justify-around justify-center items-center">
                ...
                >
                    ...
                    <p className="text-md text-neutral-600 mb-10">Desarrollador y estudiante de informática</p>
                    <Link to='/projects' className='bg-indigo-200 hover:bg-indigo-300 transition-all duration-300 p-3 rounded-sm'>¡Contactame!</Link>
                </motion.div>
