...
const About = () => {
    ...
    return (
        <div id="about" ref={ref} className="flex flex-col mt-20 justify-center text-neutral-400 items-center sm:items-start gap-10 sm:flex-row">
            <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 50 }}
                transition={{ duration: 0.8 }}
                className={`flex flex-col justify-center items-center md:items-start gap-10 md:flex-row w-full 
                    ${!isVisible ? "pointer-events-none" : ""}`}
            >
                <img src="./aboutme.png" alt="Sobre mí" className="size-1/3 shadow-lg shadow-black rounded-b-full" />

                <div className="md:w-1/2 w-5/6">
                    <p className="text-3xl text-indigo-400 font-bold mb-4">Sobre mí</p>
                    <div className="space-y-4">
                        ...
                        <p>Poseo conocimientos sólidos en <strong>bases de datos relacionales</strong>, tanto en diseño optimizado (3FN y FNBC) como en redacción de consultas SQL, lo que me permite modelar y gestionar datos de forma eficiente. Esto me ha despertado un fuerte interés por la <strong>Analítica de Datos</strong> y su aplicación para <strong>Business Intelligence</strong>, para lo cual me estoy formando actualmente como complemento de mis habilidades.</p>
